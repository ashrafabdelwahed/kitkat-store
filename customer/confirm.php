                ...
                <div class="col-md-9">
                    <div class="box">
                        ...
                        <form action="confirm.php?update_id='<?php echo $order_id; ?>'" method="POST">
                            ...
                            <div class="form-group">
                                <input type="hidden" class="form-control" name="c_order_id" value="<?php echo $order_id ?>">
                            </div>

                            <div class="text-center mt-5">
                                <button class="btn btn-danger btn-lg" name='confirm_payment'>Confirm Payment</button>
                            </div>
                        ...
                        if(isset($_POST['confirm_payment'])) {
                            ...
                            $con->exec($insert_payment);



                            $update_customer_orders = "UPDATE customer_orders SET order_status='$complete' WHERE  order_id= '$c_order_id' ";
                            $con->exec($update_customer_orders);

                            $update_padding_orders = "UPDATE padding_orders SET order_status='$complete' WHERE  order_id= '$c_order_id' ";
                            $con->exec($update_padding_orders);


                            if($update_padding_orders) {
                                echo "<script>alert('Thank You for purchasing, Your Orders Will be completed within 48 Hours work')</script>";
